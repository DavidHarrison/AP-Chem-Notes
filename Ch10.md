...
- four types of solid carbon
    ...
    - graphite
        ...
        - the molecule is flat with 120\degree angles in fused 6 member rings
...
- those without dipoles
    - most are gases at 25\degrees C (room temperature)
    - the only forces are LDF
        - depend on the size of the atom
            - large molecules (like I~2~) can be solids even without dipoles
...
## Phase Diagrams
- a polot of T vs P for a closed system with lines to indicate where there is a phase change
